...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://varbase9:C0lleen#1@localhost:3306/varbase9?new_link=true');
}

// Additional settings generated by installer:
$civicrm_paths['civicrm.files']['url'] = 'http://ubuntu-20-04-desktop:83//sites/default/files/civicrm';
$civicrm_paths['civicrm.files']['path'] = '/var/www/varbase9/docroot/sites/default/files/civicrm';
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://varbase9:C0lleen#1@localhost:3306/varbase9?new_link=true');
  }
}
...
$civicrm_root = '/var/www/varbase9/vendor/civicrm/civicrm-core/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/varbase9/docroot/sites/default/files/civicrm/templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://ubuntu-20-04-desktop:83');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'NXX3JYPTwE0w15Fzdp8dd12VUJK8WY7rxv80Y1xRrc');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/varbase9/docroot/sites/default/files/civicrm/templates_c/mail.log');
// }
