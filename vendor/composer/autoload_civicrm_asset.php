...
$GLOBALS['civicrm_asset_map']['civicrm/civicrm-core']['dest'] = $baseDir . '/docroot/libraries/civicrm/core';
...
$GLOBALS['civicrm_asset_map']['civicrm/civicrm-packages']['dest'] = $baseDir . '/docroot/libraries/civicrm/packages';
